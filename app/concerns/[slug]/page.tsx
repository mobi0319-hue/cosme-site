      ...
      <div>
        ...
        <div className="space-y-3">
          {products.map((product, i) => (
            <a key={slugifyProduct(product)} href={`/product/${slugifyProduct(product)}`}
              className="flex gap-4 bg-white rounded-2xl border border-gray-100 p-4 hover:border-pink-200 hover:shadow-sm transition-all">
